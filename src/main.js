...
arr = new EnhancedArray(2, 4, 7, 11, 13, 16, 19);
let number_of_evens = arr.count(function(element) {
    return (element % 2 === 0);
});
...
arr = new EnhancedArray(2, 4, 7, 11, 13, 16, 19);
let odds_indices = arr.find_indices(function(element) {
    return (element % 2 === 1);
});
...
arr = new EnhancedArray(2, 4, 7, 11, 13, 16, 19);
let sum_of_numbers_less_than_13 = arr.sum(function(element) {
    return (element < 13);
});
...
arr = new EnhancedArray(2, 4, 7, 11, 13, 16, 19);
let product_of_numbers_less_than_13 = arr.product(function(element) {
    return (element < 13);
});
...
arr = new EnhancedArray(2, 4, 7, 11, 13, 16, 19);
let min = arr.min(function(element) {
    return (element % 2 === 1);
});
...
arr = new EnhancedArray(2, 4, 7, 11, 13, 16, 19);
let max = arr.max(function(element) {
    return (element % 2 === 0);
});
