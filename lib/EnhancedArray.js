  ...
  _createClass(EnhancedArray, [{
    ...
    value: function add(any) {
      ...
      if (typeof any === "number" || any instanceof Number) {
        ...
        for (var _i13 = 0; _i13 < result.length; _i13++) {
          result[_i13] += any[_i13];
        }
      } else {
        result = null;
      }
    ...
    value: function subtract(any) {
      ...
      if (typeof any === "number" || any instanceof Number) {
        ...
        for (var _i14 = 0; _i14 < result.length; _i14++) {
          result[_i14] -= any[_i14];
        }
      } else {
        result = null;
      }
    ...
    value: function multiply(any) {
      ...
      if (typeof any === "number" || any instanceof Number) {
        ...
        for (var _i15 = 0; _i15 < result.length; _i15++) {
          result[_i15] *= any[_i15];
        }
      } else {
        result = null;
      }
    ...
    value: function divide(any) {
      ...
      if (typeof any === "number" || any instanceof Number) {
        ...
        for (var _i16 = 0; _i16 < result.length; _i16++) {
          result[_i16] /= any[_i16];
        }
      } else {
        result = null;
      }
    ...
    value: function exponent(any) {
      ...
      if (typeof any === "number" || any instanceof Number) {
        ...
        for (var _i17 = 0; _i17 < result.length; _i17++) {
          result[_i17] = Math.pow(result[_i17], any[_i17]);
        }
      } else {
        result = null;
      }
    ...
    value: function range(start, end) {
      ...
      if (start < end) {
        ...
        for (var _i18 = start; _i18 >= end; _i18 += step) {
          result[c] = _i18;
          c++;
        }
      }
